...
begin
  a:=strtofloat(Edit1.Text);//чтение первого операнда
  b:=strtofloat(Edit2.Text);//чтение второго операнда
  Edit3.Text:=floattostr(a*b);//произведение операндов
end;
...
begin
  case RadioGroup1.ItemIndex of
    0: Form1.Color:=clRed;//присвоение форме Красного цвета
    1: Form1.Color:=clBlue;//присвоение форме Синего цвета
    2: Form1.Color:=clWhite;//присвоение форме Белого цвета
  end;
end;
...
{-----Смена цвета фона при помощи элементов RadioButton-----}
...
begin
  Edit4.Text:='Желтый';//записать в компонент Edit текст "Желтый"
end;

procedure TForm1.Button8Click(Sender: TObject);//кнопка "Копировать"
begin
  Edit5.Text:=Edit4.Text;//скопировать текст в Edit4 из Edit5
end;
